...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/Config.txt";
    }
    ...
    namespace BotInfo
    {
        std::string BotName                 = "MicroBuro";
        std::string Authors                 = "Ross Cockburn, Carson McLean, Kent Rasmussen, Tian Wang";
